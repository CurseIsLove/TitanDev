...
from naruto import naruto, Command, logging, AdminSettings, edrep
from naruto.helpers.PyroHelpers import ReplyCheck

__MODULE__ = "Reverse"
__HELP__ = """
This module will help you to Reverse Search Media.
──「 **Google Reverse Search** 」──
-> `reverse (reply to a media)`
Reverse search any supported media by google.
──「 **TraceMoe Reverse Search** 」──
-> `areverse (reply to a media)`
Anime reverse search any supported media.
"""

screen_shot = "titan/downloads/"
...
@naruto.on_message(filters.user(AdminSettings) & filters.command("reverse", Command))
...
@naruto.on_message(filters.user(AdminSettings) & filters.command("areverse", Command))
