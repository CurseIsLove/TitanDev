...
from naruto import naruto, Message, Config
from naruto.utils import take_screen_shot, runcmd

Converted = Config.DOWN_PATH + "sticker.webp"


@naruto.on_cmd("(ghost|invert)", about={
...
@naruto.on_cmd("(mirror|flip)", about={
