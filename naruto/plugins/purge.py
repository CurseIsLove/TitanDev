...
from naruto import Owner, naruto, Command, AdminSettings, edrep
...
@naruto.on_message(filters.user(AdminSettings) & filters.command("purge", Command))
...
@naruto.on_message(filters.user(AdminSettings) & filters.command("purgeme", Command))
...
@naruto.on_message(filters.user(AdminSettings) & filters.command("del", Command))
