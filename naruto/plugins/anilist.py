...
@naruto.on_message(filters.me & filters.command(["anime"], Command))
...
@naruto.on_message(filters.me & filters.command(["character"], Command))
...
@naruto.on_message(filters.me & filters.command(["manga"], Command))
...
@naruto.on_message(filters.me & filters.command(["upcoming"], Command))
