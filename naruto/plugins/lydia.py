...
import naruto.plugins.database.lydia_db as sql
...
@naruto.on_message(filters.user(AdminSettings) & filters.command("addchat", Command))
...
@naruto.on_message(filters.user(AdminSettings) & filters.command("rmchat", Command))
