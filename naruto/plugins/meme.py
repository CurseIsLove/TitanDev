...
@naruto.on_message(filters.user(AdminSettings) & filters.command("pat", Command))
...
@naruto.on_message(filters.user(AdminSettings) & filters.command("scam", Command))
...
@naruto.on_message(filters.user(AdminSettings) & filters.command("shg", Command))
async def shg(_, message):
    await edrep(message, text=random.choice(meme_strings.shgs))


@naruto.on_message(filters.user(AdminSettings) & filters.command("spam", Command))
...
@naruto.on_message(filters.user(AdminSettings) & filters.command("spamstk", Command))
...
@naruto.on_message(filters.user(AdminSettings) & filters.command("owo", Command))
...
@naruto.on_message(filters.user(AdminSettings) & filters.command("str", Command))
...
@naruto.on_message(filters.user(AdminSettings) & filters.command("cp", Command))
...
@naruto.on_message(filters.user(AdminSettings) & filters.command("mocktxt", Command))
...
@naruto.on_message(filters.user(AdminSettings) & filters.command("fakess", Command))
...
@naruto.on_message(filters.user(AdminSettings) & filters.command("g", Command))
